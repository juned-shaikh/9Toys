...
is_national=false;
 ...
 total_nett=0;
  ...
  price_amount = 0.0;
host_name;
buy_variable2=sessionStorage.getItem("buy_variable");
      ...
      if (
        ...
        this.adminService.fethcProductWishlist(postData2).subscribe(data => {
          ...
          if (data["status"] == "1") {
            ...
            this.count1=data["wishlist"].length;
            sessionStorage.setItem("count1",this.count1)
